    ...
    <form action="{{ route('blog.store') }}" method="POST">
        ...
        <table>
            ...
            <tr>
                ...
                <td><input type="text" id="tieu_de" name="tieu_de" value="{{ old('tieu_de') }}"></td>
            </tr>
            <tr>
                <td><label for="noi_dung">Nội dung:</label></td>
                <td>
                    <textarea id="noi_dung" name="noi_dung" rows="5">{{ old('noi_dung') }}</textarea>
                </td>
            </tr>
            <tr>
                <td><label for="tac_gia">Tác giả:</label></td>
                <td><input type="text" id="tac_gia" name="tac_gia" value="{{ old('tac_gia') }}"></td>
            </tr>
        </table>
